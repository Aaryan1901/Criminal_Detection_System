...
TWILIO_ACCOUNT_SID = 'ACa50466e660bc932afc84acdba3a3b282'
TWILIO_AUTH_TOKEN = '859917b6b737e1a86071bb76f0a62c3d'
TWILIO_PHONE_NUMBER = '+14237195285'
RECIPIENT_PHONE_NUMBER = '+919786864320'


def send_sms_alert(name, detection_time, detection_date):
    try:
        ...
        print(f"Warning SMS sent to {RECIPIENT_PHONE_NUMBER} about {name}")
...
class Face_Recognizer:
    ...
    def record_criminal(self, name):
        ...
        if data is None:
            ...
            send_sms_alert(name, current_time, current_date)
        conn.commit()
        conn.close()
