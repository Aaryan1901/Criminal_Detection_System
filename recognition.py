...
# Email configuration
EMAIL_ADDRESS = 'aarim5299@gmail.com'  # Replace with your email address
EMAIL_PASSWORD = 'Aaryan_1984'  # Replace with your email password
RECIPIENT_EMAIL = 'mohanaryan21@gmail.com'  # Replace with the recipient's email address


def send_email_alert(name, detection_time, detection_date):
    try:
        msg = MIMEMultipart()
        msg['From'] = EMAIL_ADDRESS
        msg['To'] = RECIPIENT_EMAIL
        msg['Subject'] = 'Criminal Detected Alert'

        body = f'Criminal {name} detected on {detection_date} at {detection_time}.'
        ...
        print(f"Warning email sent to {RECIPIENT_EMAIL} about {name}")
...
class Face_Recognizer:
    ...
    def draw_note(self, img_rd):
        ...
        cv2.putText(img_rd, "Criminal Recognition with Deep Learning", (20, 40), self.font, 1, (255, 255, 255), 1,
                    cv2.LINE_AA)
    ...
    def record_criminal(self, name):
        ...
        if data is None:
            ...
            send_email_alert(name, current_time, current_date)
        conn.commit()
        conn.close()
                ...
                # 6.2.2 / Face cnt increase: 0->1, 0->2, ..., 1->2, ...
                    ...
                    for k in range(len(faces)):
                        ...
                        if min(self.current_frame_face_X_e_distance_list) < 0.4:
                            ...
                            # Insert criminal detection record
                            name = self.face_name_known_list[similar_person_num]
                            self.record_criminal(name)
                        else:
